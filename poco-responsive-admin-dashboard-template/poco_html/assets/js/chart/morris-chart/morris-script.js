...
var morris_chart = {
    init: function() {
        Morris.Area({
            ...
            xkey: "x",
            ykeys: ["y", "z", "a"],
            barColors: ["#7e37d8", "#fe80b2" ,"#80cf00"],
            labels: ["Y", "Z", "A"]
        }), Morris.Bar({
            ...
            Morris.Bar({
                ...
                ykeys: ["y", "z", "a"],
                labels: ["A", "Y", "Z"],
                barColors: ["#7e37d8", "#80cf00" ,"#fe80b2" ,"#ff5a75" ,"#ff9f40", "#1ea6ec" ,"#7e37d8"],
                stacked: !0
            });
        });
    }
